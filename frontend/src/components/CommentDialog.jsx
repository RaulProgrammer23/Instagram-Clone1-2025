...
import { Dialog, DialogContent, DialogTrigger, DialogTitle } from './ui/dialog'; // Asegúrate de importar DialogTitle
  ...
  return (
    <Dialog open={open}>
      <DialogContent onInteractOutside={() => setOpen(false)} className="max-w-5xl p-0 flex flex-col">
        {/* Aquí se añade el DialogTitle */}
        <DialogTitle>Comments</DialogTitle> {/* Añade un título significativo aquí */}
